...
Usage:
    sudo python ethercat_dds_driver_r.py
    sudo python ethercat_dds_driver_r.py --ifname enp3s0 --slave 2
"""
...
def main():
    ...
    print(f"[RIGHT] EtherCAT+DDS on {args.ifname}, slave={args.slave}")
    ...
    state_pub = ChannelPublisher("rt/inspire_hand_f1/state/r", inspire_hand_f1_state)
    state_pub.Init()
    touch_pub = ChannelPublisher("rt/inspire_hand_f1/touch/r", inspire_hand_f1_touch)
    touch_pub.Init()
    ...
    ctrl_sub = ChannelSubscriber("rt/inspire_hand_f1/ctrl/r", inspire_hand_f1_ctrl)
    ...
    try:
        while True:
            ...
            if call_count % 100 == 0:
                ...
                print(f"[RIGHT] {freq:.2f} Hz | angles={states['angle_act']}")
